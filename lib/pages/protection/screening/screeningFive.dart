        ...
        children: [
          ...
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_one_highlightOne,
              style: highlight),
          TextSpan(
              text:
          ...
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_one_highlightTwo,
              style: highlight),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_one_partThree),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_one_highlightThree,
              style: highlight),
          TextSpan(
              text:
    ...
    return RichText(
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_two_highlightOne,
              style: highlight),
          TextSpan(
              text:
                  AppLocalizations.of(context).screeningFive_text_two_partTwo),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_two_highlightTwo,
              style: highlight),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_two_partThree),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_two_highlightThree,
              style: highlight),
          TextSpan(
              text:
                  AppLocalizations.of(context).screeningFive_text_two_partFour),
        ],
      ),
      textScaleFactor: textScaleFactor,
    );
    ...
    return RichText(
      text: TextSpan(
        ...
        children: [
          ...
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_highlightOne,
              style: highlight),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_partTwo),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_highlightTwo,
              style: highlight),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_partThree),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_highlightThree,
              style: highlight),
          TextSpan(
              text: AppLocalizations.of(context)
                  .screeningFive_text_three_partFour),
        ],
      ),
      textScaleFactor: textScaleFactor,
    );
