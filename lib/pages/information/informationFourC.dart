...
class InformationFourC extends StatelessWidget {
        ...
        Expanded(
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset('assets/images/ABCDrules/Skinspot_C.png',
                      fit: BoxFit.contain,
                    ),
                  ),
                ),
            ...
            mainAxisAlignment: MainAxisAlignment.center,
              children: [
                ...
                Expanded(
                  flex: 10,
                  child: SizedBox(),//button(AppLocalizations.of(context).informationFour_A_title, () => handleA(), false
                  ),
                  // Text(
                ...
                // Expanded(
                //   flex: 10,
                //   child: button(AppLocalizations.of(context).informationFour_C_title, () => handleC(), true),
                // ),
                // Expanded(
                //   flex: 10,
  ...
  Widget button(String text, Function buttonFunction, bool active) {
    int c;
    if (active){
      c= 0x273233FF;}
    else {
